...
2. Download pre-trained model weights from [here](https://disk.pku.edu.cn/link/AA678AC9D624854EC2830F43F1B173BA73)
...
1. Following the tutorial in `data/README_Data` or download processed training data from [huggingface repo](#). 
